...
<html lang="en">
    ...
    <body>
        <nav class="white" role="navigation">
            <div class="nav-wrapper container"><a id="logo-container" href="#" class="brand-logo">NatPro</a>
                <ul class="right hide-on-med-and-down">
                    ...
                    <li><a href="4validation.html" class="white-text green darken-3">Validation</a></li>
        ...
        <div class="section no-pad-bot" id="index-banner">
            <div class="container">
                <!--<br><br>-->
                <h1 class="header center green-text text-darken-3">Validation</h1>
                <div class="row center">
                    <h6>Validate the gathered data from the processed files here</h6>
                </div>
                <div class="row center">
                    <h4>Compound(s)</h4>
                    <table>
                        <thead>
                            <tr>
                                <th>
                                    <button class="btn waves-effect waves-light">Select All</button>
                                    <button class="btn waves-effect waves-light">Approve All</button>
                                    <button class="btn waves-effect waves-light">Reject All</button>
                                </th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="right">
                                    <button class="btn waves-effect waves-light">Approve</button>
                                    <button class="btn waves-effect waves-light">Reject</button>
                                    <button class="btn waves-effect waves-light">View</button>
