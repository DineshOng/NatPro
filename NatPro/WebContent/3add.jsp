			...
			<form action="AddPlantServlet" method="POST" class="row">
				<div class="col s12">
					...
					<div class="col s12" id="speciesGroup">
						...
						<div class="input-field col s6">
							<select class="browser-default" name="speciesPart">
						...
						<div class="row" id="chemicalCompoundGroup">
							...
							<div class="col s12" id="biologicalActivityGroup">
								<div class="input-field col s6 offset-s2">
									...
									<label for="biologicalActivity">Biological Activity</label> <a
										class="btn-small right teal darken-4"
										id="biologicalActivityAdd" onclick="addBAFields(0)">Biological
										Activities<i class="material-icons left">add</i>
									</a>
								</div>
								<div class="input-field col s4">
									<input id="cellLine" type="text" class="validate"> <label
										for="cellLine">CellLine</label>
								</div>
							</div>
						</div>
						<a class="btn-small teal darken-4 center col s6 offset-s3"
	...
	<script>
		...
		function addIFields(pValue) {
			...
			var inputField = "<div class=\"input-field\">"
					...
					+ "<label for=\"illness" + iCtr +"\">Illness" + " (" + iCtr
					+ ")" + "</label>" + "</div>";
			if (pValue == 0) {
		...
		function addPFields(pValue) {
			...
			var inputPreparation = "<div class=\"input-field col s6\">"
			...
			$('#preparationGroup').append(inputPreparation, inputBodyPart,
		...
		function addSFields(pValue) {
			...
			var inputSpecies = "<div class=\"input-field col s6\">"
					...
					+ "<option value=\"38\">Pod</option>" + "</select>"
					+ "</div>";
