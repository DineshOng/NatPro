    ...
    <body>
        ...
        <div class="section no-pad-bot" id="index-banner">
            <div class="container">
                ...
                <form class="row" action="AddPlantServlet" method="POST">
                    <div class="col s12">
                    	<div class="input-field col s6 offset-s3">
                            <input id="commonPlantName" type="text" class="validate" name="commonPlantName">
                        ...
                        <div class="col s6" id="scientificNameGroup">
                            <div class="input-field">
                            	<input id="scientificName" type="text" class="validate" name="scientificName">
        ...
        <script>
            ...
            function addSNFields() {
            	...
            	document.getElementById("scientificNameGroup").innerHTML += 
            		...
            		+'\" type=\"text\" class=\"validate\" name=\"scientificName\"><label for=\"scientificName' + snCtr 
            ...
            function addLFields() {
				...
				document.getElementById("locationGroup").innerHTML += 
            		...
            		+'\" type=\"text\" class=\"validate\" name=\"location\"><label for=\"location' + lCtr 
            		+'\">Location' + lCtr 
