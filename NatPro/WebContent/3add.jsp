					...
					<div class="row">
						...
						<div id="preparationGroup">
							...
							<div class="input-field col s4">
								<input id="preparation" type="text" class="validate"> <label
									for="preparation">Preparation</label>
							</div>
							...
							<div class="col s3" id="illnessGroup">
								<div class="input-field">
									<input id="illness" type="text" class="validate"> <label
										for="illness">Illness</label>
								</div>
	...
	<script>
		...
		function addPFields(pValue) {
			...
			var inputBodyPart = 
				...
				"</div>";
			var inputIllness = 
				"<div class=\"col s3\" id=\"illnessGroup" + pbpCtr +"\">" + 
					"<div class=\"input-field\">" + 
						"<input id=\"illness" + iCtr +"\" type=\"text\" class=\"validate\">" + 
						"<label for=\"illness" + iCtr +"\">Illness" + " (" + iCtr + ")" + "</label>" +
					"</div>" +
			...
			$('#preparationGroup').append(inputUtilizedPlant, inputPreparation, inputBodyPart,
					inputIllness, buttonAdd);
		...
		function addBAFields(pValue, sVal, cVal) {
			...
			if (pValue == 0) {
				var inputAppend = 
					"<div class=\"input-field col s6 offset-s2\">" + 
					"<input id=\"biologicalActivity" + baclCtr +"\" type=\"text\" class=\"validate\" name=\"bioAct["+sVal+"]["+cVal+"]["+speciesArr2[sVal][cVal]+"]\">" + "<label for=\"biologicalActivity" + baclCtr +"\">Biological Activity" + " (" + baclCtr + ")" + "</label>" +

						"<a class=\"btn-small right teal darken-4\" id=\"biologicalActivityAdd\" onclick=\"addBAFields(" + pValue + "," + sVal + "," + cVal + ")\">Biological Activities<i class=\"material-icons left\">add</i></a>"
						+ "</div>"
						+ "<div class=\"input-field col s4\">"
