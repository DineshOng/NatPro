...
<body>
	...
	<div class="jumbotron bg-success">
		<div class="d-flex justify-content-center">
			<h1 class="display-4 text-white" style="display: block">
				<p id="locName">${location}</p>
			</h1>
		</div>
		<h3 class="text-white text-center">Location</h3>
	</div>
	<div class="d-flex flex-row list-group text-center ">
		<a
			...
			aria-controls="PlantList">Plant List</a>
	</div>
		...
		<div class="tab-pane fade show active" id="plantList" role="tabpanel"
			...
			<div class="d-flex justify-content-center">
				<table class="table table-hover w-auto text-center">
					...
					<tbody>
						<c:forEach items="${medPlants}" var="medPlant">
							<tr>
								<td><a href="ViewPlantServlet?medPlant=${medPlant}"><p>${medPlant}</p></a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
