  ...
  <body>
	...
	<script>
		...
		function addPFields(pValue) {
			...
			var inputPreparation = '<div class="col">'+
		...
		function addBAFields(pValue, sVal, cVal) {
			...
			if (pValue == 0) {
				...
				var inputBioAct = '<div class="col-4"> </div>'+
							  '<div class="col-4">'+
				...
				var newBioAct = newRow + inputBioAct + inputCellLine + buttonAdd + endRow;
		...
		function addCCFields(pValue) {
			...
			if (pValue == 0) {
				...
				var chemCompFields = chemComp + bioAct + buttonAdd;
		...
		function addSFields(pValue) {
			...
			var chemcompCluster = '<div id="chemicalCompoundGroup'+ sCtr+'">'+
									  ...
									  '<div class="form-group form-row">'+
										  '<div class="col-12" style="text-align: center">'+
											  '<button id="speciesAdd" type="button" class="btn btn-primary btn-lg" onclick="addSFields('+sCtr+')" style="margin-top:10px; margin-bottom: 25px">Species Part</button>'+
										  '</div>'+
									  '</div>'+
								  '</div>'; 
			var speciesComponent = speciesPPCluster + chemcompCluster;
