...
public class OntoMngr {
	...
	// OWL Classes
	private OWLClass medPlantClass, locationClass, speciesClass, genusClass, familyClass;

	// OWL Individual
	private OWLNamedIndividual medPlantIndiv, locationIndiv, speciesIndiv, genusIndiv, familyIndiv;
